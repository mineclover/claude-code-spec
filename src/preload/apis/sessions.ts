...
export function exposeSessionsAPI(): void {
  contextBridge.exposeInMainWorld('claudeSessionsAPI', {
    ...
    getSessionAnalysis: (projectPath: string, sessionId: string) =>
      ipcRenderer.invoke('claude-sessions:get-session-analysis', projectPath, sessionId),

    getUserQuestions: (projectPath: string, sessionId: string) =>
      ipcRenderer.invoke('claude-sessions:get-user-questions', projectPath, sessionId),

    getAutoGeneratedRequests: (projectPath: string, sessionId: string) =>
      ipcRenderer.invoke('claude-sessions:get-auto-generated-requests', projectPath, sessionId),
