...
if [ -f "/Users/junwoobang/go/bin/moai" ]; then
	exec "/Users/junwoobang/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/junwoobang/.local/bin/moai" ]; then
	exec "/Users/junwoobang/.local/bin/moai" statusline < "$temp_file"
fi
