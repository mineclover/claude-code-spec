 ...
 *
 * These helpers are exported as pure functions (no I/O) so any caller (batch
 * analytics, fingerprint refiner, ad-hoc inspector) can reuse the same
 * extraction without re-parsing JSONL.
 */
