/**
 * Project-level aggregation over per-session views.
 *
 * All functions are pure: they consume the `SessionMetaView` array and return
 * shapes that dashboard components render directly. No IO, no electron, no
 * appSettings.
 *
