/**
 * Interpreter registry. Maps `interpreterType` (set on each CLI tool
 * definition) to a parser implementation. New CLIs are added via
 * `registerInterpreter` from outside the package.
 */
