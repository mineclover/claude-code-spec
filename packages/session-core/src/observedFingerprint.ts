 ...
 * its sub-hashes to the static tier surfaces component-level drift: e.g. an
 * MCP server declared in the config but reported `failed` in system/init shows
 * up as a mismatch on `mcpServers`.
 */
